...
model = dict(
    type='CascadeRCNN',
    init_cfg=dict(type='Pretrained', checkpoint='work_config/cascade_mask_rcnn_r50_fpn_1x_coco_20200203-9d4dcb24.pth'),
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + './balloondatasets/balloon/val/annotation_coco.json',
    metric=['bbox', 'segm'],
    format_only=False)
